        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12">
              <a href="#about" className="text-sm hover:text-thinkless-blue transition-colors">
                Sobre
              </a>
              <a href="#services" className="text-sm hover:text-thinkless-blue transition-colors">
                Serviços
              </a>
              <a href="#testimonials" className="text-sm hover:text-thinkless-blue transition-colors">
                Depoimentos
              </a>
              <a href="#contact" className="text-sm hover:text-thinkless-blue transition-colors">
                Contato
              </a>
            </div>
          </div>
